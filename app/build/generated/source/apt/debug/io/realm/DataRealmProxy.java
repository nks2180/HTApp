...
public class DataRealmProxy extends com.app.ht.model.Data
    ...
    private void injectObjectContext() {
        ...
        this.proxyState = new ProxyState(com.app.ht.model.Data.class, this);
    ...
    @SuppressWarnings("cast")
    public static com.app.ht.model.Data createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.app.ht.model.Data obj = null;
        if (update) {
            Table table = realm.getTable(com.app.ht.model.Data.class);
            ...
            if (rowIndex != TableOrView.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.schema.getColumnInfo(com.app.ht.model.Data.class), false, Collections.<String> emptyList());
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.DataRealmProxy) realm.createObjectInternal(com.app.ht.model.Data.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.DataRealmProxy) realm.createObjectInternal(com.app.ht.model.Data.class, json.getInt("id"), true, excludeFields);
                }
            } else {
    ...
    public static com.app.ht.model.Data createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        com.app.ht.model.Data obj = new com.app.ht.model.Data();
        reader.beginObject();
    ...
    public static com.app.ht.model.Data copyOrUpdate(Realm realm, com.app.ht.model.Data object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.app.ht.model.Data) cachedRealmObject;
        } else {
            com.app.ht.model.Data realmObject = null;
    ...
    public static com.app.ht.model.Data copy(Realm realm, com.app.ht.model.Data newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.app.ht.model.Data) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.app.ht.model.Data realmObject = realm.createObjectInternal(com.app.ht.model.Data.class, ((DataRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.app.ht.model.Data object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.app.ht.model.Data.class);
        long tableNativePtr = table.getNativeTablePointer();
        DataColumnInfo columnInfo = (DataColumnInfo) realm.schema.getColumnInfo(com.app.ht.model.Data.class);
        long pkColumnIndex = table.getPrimaryKey();
        long rowIndex = TableOrView.NO_MATCH;
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        DataColumnInfo columnInfo = (DataColumnInfo) realm.schema.getColumnInfo(com.app.ht.model.Data.class);
        long pkColumnIndex = table.getPrimaryKey();
        com.app.ht.model.Data object = null;
        while (objects.hasNext()) {
            object = (com.app.ht.model.Data) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.app.ht.model.Data object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.app.ht.model.Data.class);
    ...
    public static com.app.ht.model.Data createDetachedCopy(com.app.ht.model.Data realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.app.ht.model.Data unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.app.ht.model.Data)cachedObject.object;
            } else {
                unmanagedObject = (com.app.ht.model.Data)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.app.ht.model.Data();
    ...
    static com.app.ht.model.Data update(Realm realm, com.app.ht.model.Data realmObject, com.app.ht.model.Data newObject, Map<RealmModel, RealmObjectProxy> cache) {
        ((DataRealmProxyInterface) realmObject).realmSet$name(((DataRealmProxyInterface) newObject).realmGet$name());
        ((DataRealmProxyInterface) realmObject).realmSet$state(((DataRealmProxyInterface) newObject).realmGet$state());
        return realmObject;
    }
