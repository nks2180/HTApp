...
import com.app.ht.OnSwipeRefreshListener;
import com.app.ht.R;
import com.app.ht.SlideInItemAnimator;
import com.app.ht.TaskListAdapter;
...
public class TaskCategoryFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, TaskListAdapter.OnItemClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        HTLogger.d("onViewCreated called");
        setUpFeedView();
    ...
    public void setUpFeedView() {
        HTLogger.d("setUpFeedView called");
